...
[source,dockerfile]
----
FROM bellsoft/liberica-runtime-container:jre-17.0.20_10-cds-slim-glibc as builder
WORKDIR /builder
ARG JAR_FILE=target/*.jar
COPY ${JAR_FILE} application.jar
RUN java -Djarmode=tools -jar application.jar extract --layers --destination extracted

FROM bellsoft/liberica-runtime-container:jre-17.0.20_10-cds-slim-glibc
WORKDIR /application
